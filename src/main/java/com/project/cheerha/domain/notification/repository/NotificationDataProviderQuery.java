...
public interface NotificationDataProviderQuery {
     ...
     */
    Map<Long, List<String>> findKeywordIdToUrlList(ZonedDateTime referenceTime);

    /**
     * 모든 사용자의 이메일 및 등록한 키워드를 조회하는 메서드
     * @return 사용자 이메일과 선택한 키워드를 포함한 UserDto 리스트
     */
    List<NotificationRecipientDto> findNotificationRecipientDtoList();
}