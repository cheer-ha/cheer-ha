...
|-----------------|--------------------------|-----------------------------|--------------------|
| **복잡하지 않은 로직**  | ✅ 쿼리로 해결 가능              | ✅ 이미 저장된 값을 조회하므로 간단함       | ✅ 가장 간단함           |
| **수치화 가능 여부**   | ✅ 내림차순 정렬 가능             | ❌ ‘면접 후 결정’이 대부분이라 어려움      | ✅ 수치화할 필요 없음       |
| **사용자 맞춤화**     | ✅ 사용자가 선택한 기술 요건 반영 가능   | ✅ 인기 있는 채용 공고 전달 가능         | ❌ 사용자의 선호 반영 불가능   |
| **단점**          | ⚠️ 쿼리문을 실행하면서 성능 저하 가능성  | ⚠️ 희망 연봉과 맞지 않는 채용 공고 포함 가능 | ⚠️ 사용자 관심 충족이 어려움  |
